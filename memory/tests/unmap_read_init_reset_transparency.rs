...
fn test_noop() {
    let mut design = Design::from_str(concat!(
        ...
        "    read addr=%30:4 width=#4 clk=%41 en=%21 [undef]\n",
        "}\n",
        "%60:0 = output \"rd\" %50:4\n",
    ))
    .unwrap();
...
fn test_trans() {
    let mut design = Design::from_str(concat!(
        ...
        "    init 0101\n",
        "    write addr=%10:4 data=%0:4 mask=%20:4 clk=%40 \n",
        "    read addr=%30:4 width=#4 clk=%40 clr=%42,1111 rst=%43,0000 en=%21 en>rst init=1010 [trans]\n",
        "}\n",
        "%60:0 = output \"rd\" %50:4\n",
    ))
    .unwrap();
    ...
    let mut gold = Design::from_str(concat!(
        ...
        "    init 0101\n",
        "    write addr=%10:4 data=%0:4 mask=%20:4 clk=%40\n",
        "    read addr=%30:4 width=#4 clk=%40 en=%21 [undef]\n",
        "}\n",
        "%60:1 = eq %30:4 %10:4\n",
...
fn test_trans_double() {
    let mut design = Design::from_str(concat!(
        ...
        "    read addr=%30:4 width=#4 clk=%40 clr=%42,1111 rst=%43,0000 en=%28 en>rst init=1010 [trans trans]\n",
        "}\n",
        "%60:0 = output \"rd\" %50:4\n",
    ))
    .unwrap();
    ...
    let mut gold = Design::from_str(concat!(
        ...
        "    write addr=%10:4 data=%0:4 mask=%20:4 clk=%40 \n",
        "    write addr=%14:4 data=%4:4 mask=%24:4 clk=%40 \n",
        "    read addr=%30:4 width=#4 clk=%40 en=%28 [undef undef]\n",
        "}\n",
        "%60:1 = eq %30:4 %10:4\n",
        "%61:4 = mux %60 %20:4 0000\n",
        "%70:1 = mux %61+0 %0+0 X\n",
