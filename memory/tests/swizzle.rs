...
fn test_wide_read() {
    let mut design = Design::from_str(concat!(
        ...
        "    %50:8 = read addr=%30:3 clk=%41 en=%21 init=11011000 [undef]\n",
        "}\n",
        "%60:0 = output \"rd\" %50:8\n",
    ))
    .unwrap();
    ...
    let mut gold = Design::from_str(concat!(
        ...
        "%60:1 = mux %50 %20 0\n",
        "%61:1 = mux %51 %20 0\n",
        "%70:_ = memory depth=#16 width=#1 {\n",
        "    init 0\n",
        "    init 0\n",
        "    init 0\n",
        "    init 1\n",
        "    write addr=%10:4 data=%0 mask=%60 clk=%40\n",
        "    %70:8 = read addr=%30+1 clk=%41 en=%21 init=11001100 [undef]\n",
        "}\n",
        "%80:_ = memory depth=#16 width=#1 {\n",
        "    init 1\n",
        "    init 1\n",
        "    init 0\n",
        "    init 1\n",
        "    write addr=%10:4 data=%0+1 mask=%60 clk=%40\n",
        "    %80:8 = read addr=%30+1 clk=%41 en=%21 init=10101010 [undef]\n",
        "}\n",
        "%90:_ = memory depth=#16 width=#1 {\n",
        "    write addr=%10:4 data=%0 mask=%61 clk=%40\n",
        "    %90:8 = read addr=%30+1 clk=%41 en=%21 init=11001100 [undef]\n",
        "}\n",
        "%100:_ = memory depth=#16 width=#1 {\n",
        "    write addr=%10:4 data=%0+1 mask=%61 clk=%40\n",
        "    %100:8 = read addr=%30+1 clk=%41 en=%21 init=10101010 [undef]\n",
        "}\n",
...
fn test_wide_write() {
    let mut design = Design::from_str(concat!(
        ...
        "    %50:2 = read addr=%30:5 clk=%41 en=%21 init=10 [undef]\n",
        "}\n",
        "%60:0 = output \"rd\" %50:2\n",
    ))
    .unwrap();
    ...
    let mut gold = Design::from_str(concat!(
        ...
        "    %70:1 = read addr=%30:4 clk=%41 en=%21 init=0 [undef]\n",
        "}\n",
        "%80:_ = memory depth=#16 width=#1 {\n",
        "    init 1\n",
        "    init 1\n",
